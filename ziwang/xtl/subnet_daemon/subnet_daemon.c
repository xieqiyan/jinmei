...
#define DEVICE_NAME "xtl"
#define DAEMON_NAME "xtl_daemon"
#define RADIO_TYPE 0x02
#define CONFIG_FILE_PATH "/tmp/radio_test/xtl_config.cfg"
#define EXTRA_FIELD_NAME "currentChannelNo"
