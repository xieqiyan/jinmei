...
def build_report(status: Dict[str, object]) -> bytes:
    ...
    header = (
        ...
        struct.pack(">BB", ROUTE_NUM_XTL, chain_path_num)
    )
...
def serve(args: argparse.Namespace) -> None:
    ...
    last_error_log = 0.0
    print(
        f"xtl_topology_reporter started peer_file={args.peer_file} "
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-file", default="/tmp/radio_test/xtl_config.cfg")
    ...
    parser.add_argument("--device", choices=("ckl", "xtl", "zzw"), default="xtl")
